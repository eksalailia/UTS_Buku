@extends('book.layout')
    ...
    <div class="pull-left mt-2">
        <h2>TOKO BUKU STAY - EVERYWHERE ALL AROUND THE WORLD</h2>
        <!-- Form Search -->
...
@foreach ($book as $buku)
    <tr>
        ...
        <a class="btn btninfo" href="{{ route('book.show',$buku->ID_Buku) }}">Show</a>
        <a class="btn btnprimary" href="{{ route('book.edit',$buku->ID_Buku) }}">Edit</a>
@csrf
@method('DELETE')
